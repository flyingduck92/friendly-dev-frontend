...
const Hero: React.FC<HeroProps> = ({ name = "[NAME]", text = "[YOUR HEADER]" }) => {
  return (
    <header className='text-center py-20 px-4 bg-gray-900 text-white transition-colors duration-300 ease-in-out'>
